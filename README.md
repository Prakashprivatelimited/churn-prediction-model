...
By predicting churn early, startups can:
Contact at-risk customers with discounts or support
Reduce revenue loss
...
3. Output — List of high-risk customers with churn probability score
...
churn_prediction.py - Main ML model code 
